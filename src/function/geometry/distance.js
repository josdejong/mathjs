...
export const createDistance = /* #__PURE__ */ factory(
  ...
  ({
      ...
      'Object, Object, Object': function (x, y, z) {
        if (
          ...
          if (
            ...
            const m = divideScalar(
              subtract(z.lineTwoPtY, z.lineTwoPtX),
              subtract(y.lineOnePtY, y.lineOnePtX)
            )
    ...
    function _distancePointLine3D(x, y, z, x0, y0, z0, a, b, c) {
      let num = [
        subtract(
          multiplyScalar(subtract(y0, y), c),
          multiplyScalar(subtract(z0, z), b)
        ),
        subtract(
          multiplyScalar(subtract(z0, z), a),
          multiplyScalar(subtract(x0, x), c)
        ),
        subtract(
          multiplyScalar(subtract(x0, x), b),
          multiplyScalar(subtract(y0, y), a)
        ),
      ]
      num = sqrt(
        addScalar(
