...
export const createBernoulli = /* #__PURE__ */ factory(name, dependencies, ({
  ...
  // Main implementation:
  // The first parameter `index` is a (positive integer) number specifying
  // which Bernoulli number to compute.
  // The second parameter `promote` is a function that takes an integer number
  // and returns the desired type for the Bernoulli number values.
  // The third parameter `A` is a cache array of partial computation data
  // that _bernoulli should use. Different cache arrays should be provided for
  // different types.
  // The fourth parameter `plus` is a function that adds two values of the
  // desired type.
  // The fifth parameter `times` is a function that multiplies two values of
  // the desired type.
  // The sixth parameter `divide` is a function that divides one value of
  // the desired type by another.
