...
export const createUnitClass = /* #__PURE__ */ factory(
  ...
  ({
    ...
    function Unit(value, name) {
      ...
      this.value =
        value !== undefined && value !== null ? this._normalize(value) : null
    ...
    Unit.prototype.multiply = function (other) {
      ...
      if (this.value !== null || other.value !== null) {
        ...
        const valOther =
          other.value === null ? other._normalize(1) : other.value
    ...
    Unit.prototype.to = function (valuelessUnit) {
      ...
      if (
        ...
        other.value = subtract(
          addScalar(value, thisUnitOffset),
          otherUnitOffset
        )
      }
