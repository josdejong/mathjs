...
export const gcd = createGcd({ typed, matrix, equalScalar, type: { BigNumber, DenseMatrix, SparseMatrix } })
export const lcm = createLcm({ typed, matrix, equalScalar, type: { DenseMatrix, SparseMatrix } })
...
export const mod = createMod({ typed, matrix, equalScalar, type: { DenseMatrix, SparseMatrix } })
export const multiplyScalar = createMultiplyScalar({ typed })
export const multiply = createMultiply({ typed, matrix, addScalar, multiplyScalar, equalScalar, type: { DenseMatrix, SparseMatrix } })
export const nthRoot = createNthRoot({ typed, matrix, equalScalar, type: { BigNumber, DenseMatrix, SparseMatrix } })
...
export const round = createRound({ typed, matrix, equalScalar, zeros, type: { BigNumber, DenseMatrix, SparseMatrix } })
...
export const subtract = createSubtract({ typed, matrix, equalScalar, addScalar, unaryMinus, type: { DenseMatrix, SparseMatrix } })
export const xgcd = createXgcd({ typed, config, matrix, type: { BigNumber } })
export const divide = createDivide({ typed, matrix, multiply, equalScalar, divideScalar, inv, type: { DenseMatrix, SparseMatrix } })
...
export const dotMultiply = createDotMultiply({ typed, matrix, equalScalar, multiplyScalar, type: { DenseMatrix, SparseMatrix } })
export const dotPow = createDotPow({ typed, equalScalar, matrix, pow, type: { DenseMatrix, SparseMatrix } })
export const dotDivide = createDotDivide({ typed, matrix, equalScalar, divideScalar, type: { DenseMatrix, SparseMatrix } })
