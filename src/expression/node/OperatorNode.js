        ...
        case 1: // unary operators
          {
            ...
            if (latex && operandPrecedence !== null) {
              ...
              if (
                properties[precedence][rootIdentifier].latexLeftParens === false
              ) {
                result = [false]
                break
              }
              ...
              if (
                properties[operandPrecedence][operandIdentifier].latexParens ===
                false
              ) {
                result = [false]
                break
        ...
        case 2: // binary operators
          {
            ...
            if (latex) {
              ...
              if (lhsPrecedence !== null) {
                if (
                  properties[precedence][rootIdentifier].latexLeftParens ===
                  false
                ) {
                  lhsParens = false
                }
                ...
                if (
                  properties[lhsPrecedence][lhsIdentifier].latexParens === false
                ) {
                  lhsParens = false
                }
              }
              ...
              if (rhsPrecedence !== null) {
                if (
                  properties[precedence][rootIdentifier].latexRightParens ===
                  false
                ) {
                  rhsParens = false
                }
                ...
                if (
                  properties[rhsPrecedence][rhsIdentifier].latexParens === false
                ) {
                  rhsParens = false
                }
              }
