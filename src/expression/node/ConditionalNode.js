...
export const createConditionalNode = /* #__PURE__ */ factory(name, dependencies, ({ Node }) => {
  ...
  class ConditionalNode extends Node {
     ...
     * @extends {Node}
     */
    constructor (condition, trueExpr, falseExpr, meta = defaultMetaOptions) {
      super(meta)
     ...
     */
    clone (meta) {
      return new ConditionalNode(this.condition, this.trueExpr, this.falseExpr, meta ?? { sources: this.sources })
    }
