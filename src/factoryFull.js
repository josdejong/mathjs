...
export const createDiagFull = partial(createDiag, { typed, matrix, type: { Matrix } })
...
export const createIdentityFull = partial(createIdentity, { typed, matrix, type: { BigNumber, Matrix } })
