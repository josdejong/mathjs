...
print(math.evaluate('{x: 2 + 1, y: 4}')) // {"x": 3, "y": 4}
print(math.evaluate('{"name": "John"}')) // {"name": "John"}

// create an object containing an object
print(math.evaluate('{a: 2, b: {c: 3, d: 4}}')) // {"a": 2, "b": {"c": 3, "d": 4}}
...
print(math.evaluate('obj.prop', scope)) // 42
print(math.evaluate('obj["prop"]', scope)) // 42

// set properties (returns the whole object, not the property value!)
print(math.evaluate('obj.prop = 43', scope)) // 43
print(math.evaluate('obj["prop"] = 43', scope)) // 43
