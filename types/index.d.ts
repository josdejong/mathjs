...
export const math: math.MathJsStatic
...
export type MathArray = MathNumericType[] | MathNumericType[][]
export type MathCollection = MathArray | Matrix
export type MathType = MathNumericType | Unit | MathCollection
...
export type MathJsFunctionName = keyof MathJsStatic
...
export interface MathJsStatic extends FactoryDependencies {
  e: number
  pi: number
  i: number
  Infinity: number
...
export const {
  ...
  isPrime,
  isZero,
  // import, // can't export import as it is a reserved word
  typeOf,
}: math.MathJsStatic
