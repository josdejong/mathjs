...
declare namespace math {
  ...
  type AccessorNodeCtor = new(object: MathNode, index: IndexNode) => AccessorNode
  ...
  type BlockNodeCtor = new(arr: Array<{node: MathNode} | {node: MathNode, visible: boolean}>) => BlockNode
  ...
  type ConditionalNodeCtor = new(condition: MathNode, trueExpr: MathNode, falseExpr: MathNode) => ConditionalNode
  ...
  type ConstantNodeCtor = new(constant: number) => ConstantNode
  ...
  type FunctionAssignmentNodeCtor = new(name: string, params: string[], expr: MathNode) => FunctionAssignmentNode
  ...
  type FunctionNodeCtor = new(fn: MathNode | string, args: MathNode[]) => FunctionNode
  ...
  type ObjectNodeCtor = new(properties: Record<string, MathNode>) => ObjectNode
  ...
  type OperatorNodeCtor = new(op: string, fn: string, args: MathNode[], implicit?: boolean) => OperatorNode
  ...
  type ParenthesisNodeCtor = new(content: MathNode) => ParenthesisNode
  ...
  type RangeNodeCtor = new(start: MathNode, end: MathNode, step?: MathNode) => RangeNode
  ...
  type RelationalNodeCtor = new(conditionals: string[], params: MathNode[]) => RelationalNode
  ...
  type SymbolNodeCtor = new(name: string) => SymbolNode
  ...
  interface MathJsChain {
     ...
     * @returns The residual matrix with the function applied over some dimension.
     */
    apply(dim: number, callback: (array: MathType[] | Matrix) => number): MathJsChain
