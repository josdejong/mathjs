...
Alternatives are to use [Fractions](fractions.html) which store a number as a
numerator and denominator, or [BigNumbers](bignumbers.html), which store a
number with a higher precision.
