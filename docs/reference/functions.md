...
[math.getMatrixDataType(x)](functions/getMatrixDataType.md) | Iterate over all elements of a DenseMatrix/SparseMatrix/array, and retrieves a Matrix data type.
