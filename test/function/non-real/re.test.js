...
describe('re', function() {
  ...
  describe('Quaternion', function () {
    it('should find the real part of a Quaternion', function() {
      assert.equal(math.re(math.quaternion(1,2,3,4)),1);
      assert.equal(math.re(math.quaternion()),0);
      assert.equal(math.re(math.quaternion(-4,2,3,-9)),-4);
    })
  });
