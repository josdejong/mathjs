...
describe('format', function() {
  ...
  describe.only('engineering notation', function () {
    ...
    xit('should format positive repeating three digit floating point numbers to engineering notation with precision', function() {
    ...
    xit('should format positive floating point number to engineering notation', function() {
      assert.equal(math.format(13308.0333333333, { notation: 'engineering' }), '13.308033333e+3');
    });
  });
