...
describe('simplify', function () {
  ...
  it('new options parameters', function () {
    ...
    simplifyAndCompare('y+0.1*x', '1+x/10', {y: 1})
    simplifyAndCompare('y+0.1*x', '1+x/10', {y: 1}, {exactFractions: true})
    simplifyAndCompare('y+0.1*x', '1+0.1*x', {y: 1}, {exactFractions: false})
  })
