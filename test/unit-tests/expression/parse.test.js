...
describe('parse', function () {
  ...
  describe('number', function () {
    it('should parse valid numbers', function () {
      ...
      assert.strictEqual(parseAndEval('0x7fffffff'), Math.pow(2, 31) - 1)
      assert.strictEqual(parseAndEval('0x7fffffffi32'), Math.pow(2, 31) - 1)
      assert.strictEqual(parseAndEval('0x1fffffffffffff'), Math.pow(2, 53) - 1)
