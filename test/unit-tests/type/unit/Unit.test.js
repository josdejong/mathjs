...
describe('Unit', function () {
  ...
  describe('toBest', function () {
    ...
    it('should return the best unit with valueless unit as parameter', function () {
      ...
      // assert.equal(new Unit((50 / 5), 'm').toBest([new Unit(null, 'mm'), new Unit(null, 'km'), new Unit(null, 'cm')]).units[0].unit.name, 'm')
      // assert.equal(new Unit((50 / 5), 'm').toBest([new Unit(null, 'mm'), new Unit(null, 'km'), new Unit(null, 'cm')]).units[0].prefix.name, 'm')
      // assert.equal(new Unit((50 / 5), 'm').toBest([new Unit(null, 'mm'), new Unit(null, 'km'), new Unit(null, 'cm')]).value, 10000)
    })
