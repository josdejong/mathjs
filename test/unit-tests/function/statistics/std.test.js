...
describe('std', function () {
  ...
  it('should return the standard deviation value along a dimension on a matrix', function () {
    ...
    assert.deepStrictEqual(std(inputMatrix, 0), [
      [math.sqrt(6000), math.sqrt(6000)],
      [math.sqrt(6225), math.sqrt(5825)],
      [math.sqrt(5825), math.sqrt(5825)],
    ])
    assert.deepStrictEqual(std(inputMatrix, 1), [
      [math.sqrt(400), math.sqrt(7600)],
      [math.sqrt(3433.3333333333335), math.sqrt(400.0)],
      [math.sqrt(433.33333333333337), math.sqrt(433.33333333333337)],
      [math.sqrt(400.0), math.sqrt(14800)],
    ])
    assert.deepStrictEqual(std(inputMatrix, 2), [
      [math.sqrt(18050), math.sqrt(50), math.sqrt(50)],
      [math.sqrt(50), math.sqrt(50), math.sqrt(1800)],
      [math.sqrt(50), math.sqrt(50), math.sqrt(1800)],
      [math.sqrt(14450), math.sqrt(50), math.sqrt(50)],
    ])
  })
