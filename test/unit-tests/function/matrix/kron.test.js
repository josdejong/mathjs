...
describe('kron', function () {
  it('should calculate the kronecker product of two arrays', function () {
    ...
    assert.deepStrictEqual(
      ...
      [
        [
          5247, 2968, 1166, 371, 1188, 672, 264, 84, -891, -504, -198, -63, 0,
          0, 0, 0,
        ],
        [
          198, 112, 44, 14, 198, 112, 44, 14, 495, 280, 110, 35, 198, 112, 44,
          14,
        ],
      ]
    )
  ...
  it('should calculate product for 1D Arrays', function () {
    ...
    assert.deepStrictEqual(math.kron([1, 2, 6, 8], [12, 1, 2, 3]), [
      [12, 1, 2, 3, 24, 2, 4, 6, 72, 6, 12, 18, 96, 8, 16, 24],
    ])
  })
  ...
  describe('DenseMatrix', function () {
    it('should calculate the kronecker product of a 2d matrix (1)', function () {
      ...
      assert.deepStrictEqual(product.valueOf(), [
        [1, 1, 0, 0],
        [1, 1, 0, 0],
        [0, 0, 1, 1],
        [0, 0, 1, 1],
    ...
    it('should calculate the kronecker product of a 2d matrix (2)', function () {
      ...
      const product = math.kron(x, y)
      assert.deepStrictEqual(product.toArray(), [
        [13, 26, 0, 0],
        [715, -13, 0, -0],
        [0, 0, -1, -2],
        [0, -0, -55, 1],
