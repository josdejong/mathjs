...
describe('rotationMatrix', function () {
  it('should return a rotated 1x2 vector when it is provided as array', function () {
    assert.deepStrictEqual(rotate([1, 0], 0), matrix([1, 0]))

    assert.deepStrictEqual(rotate([100, 0], 1), matrix([100 * cos(1), 100 * sin(1)]))
    assert.deepStrictEqual(rotate([2, 3], 2), matrix([2 * cos(2) - 3 * sin(2), 2 * sin(2) + 3 * cos(2)]))

    const cos45 = cos(unit('45deg'))
    const sin45 = sin(unit('45deg'))
    assert.deepStrictEqual(rotate([4, 5], unit('45deg')), matrix([4 * cos45 - 5 * sin45,
      4 * cos45 + 5 * sin45]))
  ...
  it('should return a rotated 1x2 bignumber vector', function () {
    ...
    assert.deepStrictEqual(bigmath.rotate([big2, big3], bigmath.bignumber(1)),
      bigmath.matrix([add(cos1.times(big2), minusSin1.times(big3)), add(sin1.times(big2), cos1.times(big3))]))
  })
  ...
  it('should return a rotated 1x3 bignumber vector', function () {
    ...
    assert.deepStrictEqual(bigmath.rotate([big2, big3, big4], bigmath.bignumber(1), [0, 0, 1]),
      bigmath.matrix([add(cos1.times(big2), minusSin1.times(big3)), add(sin1.times(big2), cos1.times(big3)), big4]))
  })
