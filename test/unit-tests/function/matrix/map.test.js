...
describe('map', function () {
  it('should apply map to all elements of the matrix', function () {
    ...
    const m2 = math.map(m, function (value) {
      return value * 2
    })
  ...
  it('should apply deep-map to all elements in the array', function () {
    ...
    const arr2 = math.map(arr, function (value) {
      return value * 2
    })
  ...
  it('should invoke callback with parameters value, index, obj', function () {
    ...
    assert.deepStrictEqual(
      math
        .map(arr, function (value, index, obj) {
  ...
  it('should throw an error if the callback argument types are incorrect', function () {
  ...
  it('should LaTeX map', function () {
    ...
    assert.strictEqual(
      expression.toTex(),
      '\\mathrm{map}\\left(\\begin{bmatrix}1\\\\2\\\\3\\end{bmatrix}, callback\\right)'
    )
  })
})
