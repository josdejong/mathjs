...
describe('cos', function () {
  ...
  it('should return the cosine of a bignumber', function () {
    ...
    const resultVal =
      '-0.99947004918247698171247470962484532559534008595265991588' +
    ...
    assert.deepStrictEqual(
      bigmath.cos(bigmath.bignumber(6)).toString(),
      '0.960170286650366'
    )
    assert.deepStrictEqual(
      bigmath.cos(bigmath.bignumber(7)).toString(),
      '0.753902254343305'
    )
    ...
    assert.deepStrictEqual(
      bigmath.cos(bigPi.div(4)).toString(),
      '0.7071067811865475'
    )
  ...
  it('should return the cosine of a complex number', function () {
    ...
    approx.deepEqual(cos(complex('1')), complex(0.54030230586814, 0))
    approx.deepEqual(
      cos(complex('1+i')),
      complex(0.833730025131149, -0.988897705762865)
    )
  ...
  it('should return the cosine of an angle', function () {
    ...
    approx.equal(
      cos(unit(math.bignumber(45), 'deg')).toNumber(),
      0.707106781186548
    )

    approx.deepEqual(
      cos(unit(complex(1, 1), 'rad')),
      complex(0.833730025131149, -0.988897705762865)
    )
  })
