...
describe('tan', function () {
  it('should return the tangent of a boolean', function () {
    approx.equal(tan(true), 1.5574077246549)
  ...
  it('should return the tangent of a bignumber', function () {
    ...
    assert.deepStrictEqual(
      bigTan(bigPi.div(8)).toString(),
      '0.414213562373095048802'
    )
    // Wolfram:                                        0.414213562373095048801688724209698078569671875376948073176
    assert.deepStrictEqual(
      bigTan(bigPi.div(4)).toString(),
  ...
  it('should return the tangent of a complex number', function () {
    ...
    approx.deepEqual(tan(complex('1')), complex(1.5574077246549, 0))
    approx.deepEqual(
      tan(complex('1+i')),
      complex(0.271752585319512, 1.083923327338695)
    )
  })
