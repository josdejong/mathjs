...
describe('acos', function () {
  ...
  it('should return the arccos of a bignumber', function () {
    ...
    assert.deepStrictEqual(
      bigmath61.acos(bigmath61.bignumber(0.00000001)),
      bigmath61.bignumber(
        '1.570796316794896619231321524973084775431910533020886243820359'
      )
    )
  ...
  it('should be the inverse function of bignumber cos', function () {
    ...
    assert.deepStrictEqual(
      acosBig(cosBig(Big(0.1))),
      Big('0.099999999999999999956')
    )
    assert.deepStrictEqual(
      acosBig(cosBig(Big(0.5))),
      Big('0.49999999999999999999')
    )
  ...
  it('should return the arccos of a complex number', function () {
    ...
    approx.deepEqual(
      acos(complex('-2+3i')),
      complex(2.141449111116, -1.98338702991654)
    )
    approx.deepEqual(
      acos(complex('-2-3i')),
      complex(2.141449111116, 1.98338702991654)
    ...
    approx.deepEqual(
      acos(complex('1+i')),
      complex(0.904556894302381, -1.061275061905036)
    )
  })
  ...
  it('should calculate the arccos element-wise for arrays and matrices', function () {
    ...
    const acos123 = [
      0,
      complex(0, 1.316957896924817),
      complex(0, 1.762747174039086),
    ]
