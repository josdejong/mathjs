...
describe('asec', function () {
  ...
  it('should return the arcsec of a bignumber', function () {
    ...
    assert.deepStrictEqual(
      bigmath64.asec(bigmath64.bignumber(3)),
      bigmath64.bignumber(
        '1.230959417340774682134929178247987375710340009355094839055548334'
      )
    )
    ...
    assert.deepStrictEqual(
      bigmath64.asec(arg),
      bigmath64.bignumber(
        '1.230959418519285979938614206185297709155969929825366328254265441'
      )
    )
  ...
  it('should be the inverse function of bignumber sec', function () {
    ...
    assert.deepStrictEqual(
      asecBig(bigmath.sec(Big(0.5))),
      Big('0.49999999999999999997')
    )
  ...
  it('should return the arcsec of a complex number', function () {
    ...
    approx.deepEqual(
      asec(complex('-2+3i')),
      complex(1.7211819311228, 0.2313346985739733)
    )
    approx.deepEqual(
      asec(complex('-2-3i')),
      complex(1.7211819311228, -0.2313346985739733)
    ...
    approx.deepEqual(
      asec(complex('i')),
      complex(1.570796326794897, 0.881373587019543)
    )
    approx.deepEqual(
      asec(complex('1+i')),
      complex(1.1185178796437059, 0.530637530952517826)
    )
