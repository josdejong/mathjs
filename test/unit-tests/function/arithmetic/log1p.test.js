...
describe('log1p', function () {
  ...
  it('should return the log1p of positive numbers', function () {
    ...
    approx.deepEqual(log1p(2), 1.09861228866811)
  ...
  it('should return the log1p of negative numbers', function () {
    ...
    approx.deepEqual(
      log1p(-3),
      complex('0.693147180559945 + 3.141592653589793i')
    )
    approx.deepEqual(
      log1p(-4),
      complex('1.098612288668110 + 3.141592653589793i')
    )
  })
  ...
  it('should return the log1p of positive bignumbers', function () {
    ...
    assert.deepStrictEqual(
      bigmath.log1p(bigmath.bignumber(-1)).toString(),
      '-Infinity'
    )
    assert.deepStrictEqual(
      bigmath.log1p(bigmath.bignumber(0)),
      bigmath.bignumber('0')
    )
    assert.deepStrictEqual(
      bigmath.log1p(bigmath.bignumber(1)),
      bigmath.bignumber(
        '0.6931471805599453094172321214581765680755001343602552541206800094933936219696947156058633269964186875'
      )
    )
    assert.deepStrictEqual(
      bigmath.log1p(bigmath.bignumber(2)),
      bigmath.bignumber(
    ...
    assert.deepStrictEqual(
      bigmath.log1p(bigmath.bignumber(999), bigmath.bignumber(10)),
      bigmath.bignumber(3)
    )
  })
  ...
  it('should return the log1p of negative bignumbers', function () {
    ...
    approx.deepEqual(
      bigmath.log1p(bigmath.bignumber(-3)),
      complex('0.693147180559945 + 3.141592653589793i')
    )
    approx.deepEqual(
      bigmath.log1p(bigmath.bignumber(-4)),
      complex('1.098612288668110 + 3.141592653589793i')
    )
  })
  ...
  it('should return the log1p of a complex number', function () {
    ...
    approx.deepEqual(
      log1p(complex(1, 1)),
      complex('0.80471895621705 + 0.463647609000806i')
    )
    approx.deepEqual(
      log1p(complex(1, -1)),
      complex('0.80471895621705 - 0.463647609000806i')
  ...
  it('should return the log1p of each element of a matrix', function () {
    ...
    approx.deepEqual(
      ...
      matrix([
        [0, 0.693147180559945],
        [1.09861228866811, 1.386294361119891],
      ])
    )
  })
