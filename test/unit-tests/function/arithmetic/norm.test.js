...
describe('norm', function () {
  ...
  it('should return the absolute value of a big number', function () {
    ...
    assert.deepStrictEqual(
      math.norm(math.bignumber(-2.3), 'fro'),
      math.bignumber(2.3)
    )
    assert.deepStrictEqual(
      math.norm([math.bignumber(-2.3)], 'fro'),
  ...
  it('should return the norm of a complex number', function () {
    ...
    assert.strictEqual(
      ...
      4.12310562561766e200
    )
    assert.strictEqual(
      math.norm(math.complex(-4e200, 1e200)),
      4.12310562561766e200
    )
    assert.strictEqual(
      math.norm(math.matrix([[math.complex(3, -4)]]), 'fro'),
      5
    )
  })
  ...
  it('should return the norm of a vector', function () {
    ...
    assert.strictEqual(
      math.norm(math.matrix([1, 2, -3]), Number.POSITIVE_INFINITY),
      3
    )
    ...
    assert.strictEqual(
      math.norm(math.matrix([1, 2, -3]), Number.NEGATIVE_INFINITY),
      1
    )
