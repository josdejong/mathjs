...
describe('bignumber', function () {
  it('should calculate a bignumber e', function () {
    ...
    assert.strictEqual(
      createBigNumberE(Big64).toString(),
  ...
  it('should calculate a bignumber pi', function () {
    ...
    assert.strictEqual(
      createBigNumberPi(Big64).toString(),
  ...
  it('should calculate a bignumber tau', function () {
    ...
    assert.strictEqual(
      createBigNumberTau(Big64).toString(),
  ...
  it('should calculate a bignumber phi', function () {
    ...
    assert.strictEqual(
      createBigNumberPhi(Big32).toString(),
      '1.6180339887498948482045868343657'
    )
    assert.strictEqual(
      createBigNumberPhi(Big64).toString(),
