...
describe('config', function () {
  ...
  it('should work with config legacySubset during deprecation', function () {
    ...
    assert.ok(math2.norm(math2.subtract(math2.sylvester(sylvesterA, sylvesterB, sylvesterC), sylvesterSol), 'fro') < 1e-3)
    ...
    assert.ok(math2.norm(math2.subtract(math2.sylvester(
      sylvesterA, sylvesterB, sylvesterC), sylvesterSol), 'fro') < 1e-3)
