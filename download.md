...
<table class="download">
  <tr>
    <td>
      <a href="http://cdnjs.cloudflare.com/ajax/libs/mathjs/3.12.2/math.js">
        Development (version 3.12.2)
      </a>
    </td>
    <td>
      <span id="development-size">1525 kB</span>, uncompressed with comments
    </td>
  </tr>
  <tr>
    <td>
      <a href="http://cdnjs.cloudflare.com/ajax/libs/mathjs/3.12.2/math.min.js">
        Production (version 3.12.2)
      </a>
    </td>
    <td>
      <span id="production-size">121 kB</span>, minified and gzipped
    </td>
  </tr>
</table>
