...
exports.isBigNumber = function (value) {
  return value && value.isBigNumber === true;
};
...
/**
* Determines if n is a positive integer or zero
* @param {Number | BigNumber} n   Input value
* @return {Boolean} Returns true when the number is positive or zero
*/
