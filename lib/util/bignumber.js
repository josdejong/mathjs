...
exports.pi = function (precision) {
  var Big = BigNumber.constructor({precision: precision});
  if (precision < 1015) {
    // extra precision to get the correct rounding mode result
    return new Big(piStr.slice(0, precision + 2)).toDP(precision-1);
  }
...
var piStr = 
  ...
  '171226806613001927876611195909216420198938095257201065';
