...
exports.format = function format(value, options) {
  ...
  switch (notation) {
    ...
    case 'auto':
      ...
      oldConfig = {
        toExpNeg: oldConfig.toExpNeg,
        toExpPos: oldConfig.toExpPos
      };
      ...
      if (abs.gte(lower) && abs.lt(upper)) {
        ...
        // Note: in bignumber.js, function round rounds to significant digits
        str = value.round(precision).toFixed();
      }
      else {
