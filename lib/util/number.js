...
* @param {Number} value1
* @param {Number} value1
* @param {Number} maximumRelativeDifference
* @return {boolean} wether the two numbers are equal
*/
exports.nearlyEqual = function(x, y, maximumRelativeDifference) {
  ...
  if(isFinite(x) && isFinite(y)) {
    ...
    if (diff < exports.DBL_EPSILON) 
      return true;
    // use relative error
    return diff <= Math.max(Math.abs(x) + Math.abs(y)) * maximumRelativeDifference;
  }
