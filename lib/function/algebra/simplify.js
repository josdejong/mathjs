...
function factory (type, config, load, typed) {
  ...
  /**
   * Given an expression tree, returns a simplified expression tree.
   *
   ...
   *
   * @param  {Node | string} expr   The expression to be simplified
   * @param  {string[]} [rules]     Optional list with custom rules
   * @return {Node} The simplified form of `expr`
   */
