...
//function stri(st, expr){   //XXX
//  console.log(st + "> " + expr.toString({parenthesis: 'all'}).replace(/ /g,''));
//}

function retStr(st,expr) { //XXX 
 return st + "> " + expr.toString({parenthesis: 'all'}).replace(/ /g,'');
}
var glob="";
...
//        stri('N',expr.args[0])  //XXX
//        stri('D',expr.args[1])  //XXX 
