  ...
  var _denseLUP = function (m) {
    ...
    for (j = 0; j < columns; j++) {
      ...
      if (j !== pi) {
        ...
        DenseMatrix._swapRows(j, pi, p._data);
        // swap j <-> pi in data
    ...
    for (j = 0; j < columns; j++) {
      ...
      if (j > 0) {
        ...
        spa.forEach(0, j - 1, function (k, vkj) {
          ...
          CcsMatrix._forEachRow(k, lvalues, lindex, lptr, function (i, vik) {
      ...
      if (j !== pi) {
        ...
        CcsMatrix._swapRows(j, pi, lsize[1], lvalues, lindex, lptr);
        // swap values j <-> pi in U
        CcsMatrix._swapRows(j, pi, usize[1], uvalues, uindex, uptr);
        // swap values in spa
        spa.swap(j, pi);
