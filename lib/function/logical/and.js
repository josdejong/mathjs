...
function factory (type, config, load, typed) {
  ...
  var and = typed('and', {
      ...
      switch (x.storage()) {
        ...
        default:
          switch (y.storage()) {
            ...
            default:
              // dense & dense
              c = elementWiseOperations.algorithm12(x, y, and);
              break;
          }
          break;
      }
    ...
    'Matrix, any': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm10(x, y, and, false);
          break;
        default:
          c = elementWiseOperations.algorithm13(x, y, and, false);
          break;
      }
      return c;
    },
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm10(y, x, and, true);
          break;
        default:
          c = elementWiseOperations.algorithm13(y, x, and, true);
          break;
      }
      return c;
    },
