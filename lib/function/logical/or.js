...
function factory (type, config, load, typed) {
  ...
  var or = typed('or', {
      ...
      switch (x.storage()) {
        ...
        default:
          switch (y.storage()) {
            ...
            default:
              // dense + dense
              c = elementWiseOperations.algorithm11(x, y, or);
              break;
          }
          break;
      }
    ...
    'Matrix, any': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm10(x, y, or, false);
          break;
        default:
          c = elementWiseOperations.algorithm12(x, y, or, false);
          break;
      }
      return c;
    },
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm10(y, x, or, true);
          break;
        default:
          c = elementWiseOperations.algorithm12(y, x, or, true);
          break;
      }
      return c;
    },
    ...
    'Array, any': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm12(matrix(x), y, or, false).valueOf();
    },

    'any, Array': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm12(matrix(y), x, or, true).valueOf();
    }
  });
