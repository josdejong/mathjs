...
function factory (type, config, load, typed) {
  ...
  var larger = typed('larger', {
    ...
    'Matrix, any': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          c = algorithm11(x, y, larger, false);
          break;
        default:
          c = algorithm13(x, y, larger, false);
          break;
      }
      return c;
    },
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = algorithm11(y, x, larger, true);
          break;
        default:
          c = algorithm13(y, x, larger, true);
          break;
      }
      return c;
    },
    ...
    'Array, any': function (x, y) {
      // use matrix implementation
      return algorithm13(matrix(x), y, larger, false).valueOf();
    },

    'any, Array': function (x, y) {
      // use matrix implementation
      return algorithm13(matrix(y), x, larger, true).valueOf();
    }
  });
