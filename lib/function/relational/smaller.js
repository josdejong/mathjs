...
function factory (type, config, load, typed) {
  ...
  var smaller = typed('smaller', {
    ...
    'Matrix, any': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          c = algorithm11(x, y, smaller, false);
          break;
        default:
          c = algorithm13(x, y, smaller, false);
          break;
      }
      return c;
    },
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = algorithm11(y, x, smaller, true);
          break;
        default:
          c = algorithm13(y, x, smaller, true);
          break;
      }
      return c;
    },
    ...
    'Array, any': function (x, y) {
      // use matrix implementation
      return algorithm13(matrix(x), y, smaller, false).valueOf();
    },

    'any, Array': function (x, y) {
      // use matrix implementation
      return algorithm13(matrix(y), x, smaller, true).valueOf();
    }
  });
