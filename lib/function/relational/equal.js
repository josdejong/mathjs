...
function factory (type, config, load, typed) {
  ...
  var equal = typed('equal', {
    ...
    'Matrix, any': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          c = algorithm11(x, y, equalScalar, false);
          break;
        default:
          c = algorithm13(x, y, equalScalar, false);
          break;
      }
      return c;
    },
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = algorithm11(y, x, equalScalar, true);
          break;
        default:
          c = algorithm13(y, x, equalScalar, true);
          break;
      }
      return c;
    },
    ...
    'Array, any': function (x, y) {
      // use matrix implementation
      return algorithm13(matrix(x), y, equalScalar, false).valueOf();
    },

    'any, Array': function (x, y) {
      // use matrix implementation
      return algorithm13(matrix(y), x, equalScalar, true).valueOf();
    }
  });
