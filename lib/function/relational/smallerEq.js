...
function factory (type, config, load, typed) {
  ...
  var smallerEq = typed('smallerEq', {
    ...
    'Matrix, any': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          c = algorithm11(x, y, smallerEq, false);
          break;
        default:
          c = algorithm13(x, y, smallerEq, false);
          break;
      }
      return c;
    },
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = algorithm11(y, x, smallerEq, true);
          break;
        default:
          c = algorithm13(y, x, smallerEq, true);
          break;
      }
      return c;
    },
    ...
    'Array, any': function (x, y) {
      // use matrix implementation
      return algorithm13(matrix(x), y, smallerEq, false).valueOf();
    },

    'any, Array': function (x, y) {
      // use matrix implementation
      return algorithm13(matrix(y), x, smallerEq, true).valueOf();
    }
  });
