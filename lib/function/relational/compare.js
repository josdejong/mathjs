...
function factory (type, config, load, typed) {
  ...
  var compare = typed('compare', {
    ...
    'Matrix, any': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          c = algorithm11(x, y, compare, false);
          break;
        default:
          c = algorithm13(x, y, compare, false);
          break;
      }
      return c;
    },
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = algorithm11(y, x, compare, true);
          break;
        default:
          c = algorithm13(y, x, compare, true);
          break;
      }
      return c;
    },
    ...
    'Array, any': function (x, y) {
      // use matrix implementation
      return algorithm13(matrix(x), y, compare, false).valueOf();
    },

    'any, Array': function (x, y) {
      // use matrix implementation
      return algorithm13(matrix(y), x, compare, true).valueOf();
    }
  });
