...
function factory (type, config, load, typed) {
  ...
  var bitOr = typed('bitOr', {
        ...
        default:
          switch (y.storage()) {
            case 'sparse':
              ...
              break;
            default:
              c = elementWiseOperations.algorithm11(x, y, bitOr);
              break;
          }
          break;
      }
    ...
    'Matrix, any': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm8(x, y, bitOr, false);
          break;
        default:
          c = elementWiseOperations.algorithm12(x, y, bitOr, false);
          break;
      }
      return c;
    },
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm8(y, x, bitOr, true);
          break;
        default:
          c = elementWiseOperations.algorithm12(y, x, bitOr, true);
          break;
      }
      return c;
    },
    ...
    'Array, any': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm12(matrix(x), y, bitOr, false).valueOf();
    },

    'any, Array': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm12(matrix(y), x, bitOr, true).valueOf();
    }
  });
