...
function factory (type, config, load, typed) {
  ...
  var bitOr = typed('bitOr', {
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          ...
          break;
        default:
          c = elementWiseOperations.algorithm10(y, x, bitOr, true);
          break;
      }
      return c;
    },
    ...
    'Array, any': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm10(matrix(x), y, bitOr, false).valueOf();
    },

    'any, Array': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm10(matrix(y), x, bitOr, true).valueOf();
    }
  });
