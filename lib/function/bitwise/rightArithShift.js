  ...
  var rightArithShift = typed('rightArithShift', {
      ...
      switch (x.storage()) {
        case 'sparse':
          switch (y.storage()) {
            case 'sparse':
              // sparse & sparse
              c = elementWiseOperations.algorithm8(x, y, rightArithShift, false);
              break;
            default:
              // sparse & dense
              c = elementWiseOperations.algorithm2(y, x, rightArithShift, true);
              break;
          }
          break;
        default:
          switch (y.storage()) {
            case 'sparse':
              // dense & sparse
              c = elementWiseOperations.algorithm1(x, y, rightArithShift, false);
              break;
            default:
              // dense & dense
              c = elementWiseOperations.algorithm12(x, y, rightArithShift);
              break;
          }
          break;
      }
    ...
    'Matrix, number | BigNumber': function (x, y) {
      ...
      if (!equal(y, 0)) {
        ...
        switch (x.storage()) {
          case 'sparse':
            c = elementWiseOperations.algorithm10(x, y, rightArithShift, false);
            break;
          default:
            c = elementWiseOperations.algorithm13(x, y, rightArithShift, false);
            break;
        }
        return c;
      }
    ...
    'number | BigNumber, Matrix': function (x, y) {
      ...
      if (!equal(x, 0)) {
        ...
        switch (y.storage()) {
          case 'sparse':
            c = elementWiseOperations.algorithm9(y, x, rightArithShift, true);
            break;
          default:
            c = elementWiseOperations.algorithm13(y, x, rightArithShift, true);
            break;
        }
        return c;
      }
