...
function factory (type, config, load, typed) {
  ...
  var bitXor = typed('bitXor', {
    ...
    'Matrix, any': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          c = algorithm11(x, y, bitXor, false);
          break;
        default:
          c = algorithm13(x, y, bitXor, false);
          break;
      }
      return c;
    },
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = algorithm11(y, x, bitXor, true);
          break;
        default:
          c = algorithm13(y, x, bitXor, true);
          break;
      }
      return c;
    },
    ...
    'Array, any': function (x, y) {
      // use matrix implementation
      return algorithm13(matrix(x), y, bitXor, false).valueOf();
    },

    'any, Array': function (x, y) {
      // use matrix implementation
      return algorithm13(matrix(y), x, bitXor, true).valueOf();
    }
  });
