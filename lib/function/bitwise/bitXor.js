...
function factory (type, config, load, typed) {
  ...
  var bitXor = typed('bitXor', {
      ...
      switch (x.storage()) {
        ...
        default:
          switch (y.storage()) {
            ...
            default:
              // dense + dense
              c = elementWiseOperations.algorithm11(x, y, bitXor);
              break;
          }
          break;
      }
    ...
    'Matrix, any': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm10(x, y, bitXor, false);
          break;
        default:
          c = elementWiseOperations.algorithm12(x, y, bitXor, false);
          break;
      }
      return c;
    },
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm10(y, x, bitXor, true);
          break;
        default:
          c = elementWiseOperations.algorithm12(y, x, bitXor, true);
          break;
      }
      return c;
    },
    ...
    'Array, any': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm12(matrix(x), y, bitXor, false).valueOf();
    },

    'any, Array': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm12(matrix(y), x, bitXor, true).valueOf();
    }
  });
