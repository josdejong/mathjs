...
function factory (type, config, load, typed) {
  ...
  var bitAnd = typed('bitAnd', {
    ...
    'Matrix, any': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm8(x, y, bitAnd, false);
          break;
        default:
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm8(y, x, bitAnd, true);
          break;
        default:
          c = elementWiseOperations.algorithm11(y, x, bitAnd, true);
          break;
      }
      return c;
    },
    ...
    'Array, any': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm11(matrix(x), y, bitAnd, false).valueOf();
    },

    'any, Array': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm11(matrix(y), x, bitAnd, true).valueOf();
    }
  });
