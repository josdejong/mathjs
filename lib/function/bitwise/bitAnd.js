...
function factory (type, config, load, typed) {
  ...
  var bitAnd = typed('bitAnd', {
      ...
      switch (x.storage()) {
        ...
        default:
          switch (y.storage()) {
            ...
            default:
              // dense & dense
              c = elementWiseOperations.algorithm12(x, y, bitAnd);
              break;
          }
          break;
      }
    ...
    'Matrix, any': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm10(x, y, bitAnd, false);
          break;
        default:
          c = elementWiseOperations.algorithm13(x, y, bitAnd, false);
          break;
      }
      return c;
    },
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm10(y, x, bitAnd, true);
          break;
        default:
          c = elementWiseOperations.algorithm13(y, x, bitAnd, true);
          break;
      }
      return c;
    },
    ...
    'Array, any': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm13(matrix(x), y, bitAnd, false).valueOf();
    },

    'any, Array': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm13(matrix(y), x, bitAnd, true).valueOf();
    }
  });
