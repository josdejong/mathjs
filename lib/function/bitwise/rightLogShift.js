  ...
  var rightLogShift = typed('rightLogShift', {
      ...
      switch (x.storage()) {
        ...
        default:
          switch (y.storage()) {
            ...
            default:
              // dense & dense
              c = algorithm12(x, y, rightLogShift);
              break;
          }
          break;
      }
    ...
    'Matrix, number | BigNumber': function (x, y) {
      ...
      if (!equalScalar(y, 0)) {
        ...
        switch (x.storage()) {
          case 'sparse':
            c = algorithm10(x, y, rightLogShift, false);
            break;
          default:
            c = algorithm13(x, y, rightLogShift, false);
            break;
        }
        return c;
      }
    ...
    'number | BigNumber, Matrix': function (x, y) {
      ...
      if (!equalScalar(x, 0)) {
        ...
        switch (y.storage()) {
          case 'sparse':
            c = algorithm09(y, x, rightLogShift, true);
            break;
          default:
            c = algorithm13(y, x, rightLogShift, true);
            break;
        }
        return c;
      }
