  ...
  var leftShift = typed('leftShift', {
    ...
    'Matrix, number | BigNumber': function (x, y) {
      ...
      if (!equal(y, 0)) {
        ...
        switch (x.storage()) {
          case 'sparse':
            c = algorithm10(x, y, leftShift, false);
            break;
          default:
            c = algorithm13(x, y, leftShift, false);
            break;
        }
        return c;
      }
    ...
    'number | BigNumber, Matrix': function (x, y) {
      ...
      if (!equal(x, 0)) {
        ...
        switch (y.storage()) {
          case 'sparse':
            c = algorithm09(y, x, leftShift, true);
            break;
          default:
            c = algorithm13(y, x, leftShift, true);
            break;
        }
        return c;
      }
