...
function factory (type, config, load, typed, math) {
  ...
  function _import(name, value, options) {
    ...
    if (options.override || math[name] === undefined) {
      ...
      math.type.Chain.createProxy(name, value); // FIXME: remove this
  ...
  function _importFactory(factory) {
    ...
    if (typeof factory.name === 'string') {
      ...
      // TODO: make factory.name optional, if not provided, do not add to math namespace but just return -> remove the names from all transform functions
