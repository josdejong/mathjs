...
function factory (type, config, load, typed) {
   ...
   * @param {number | BigNumber | Complex | Quaternion} [base=e]
   *            Optional base for the logarithm. If not provided, the natural
   *            logarithm of `x` is calculated.
   * @return {number | BigNumber | Complex | Array | Matrix | Quaternion}
  ...
  var log = typed('log', {
    ...
    'Quaternion, BigNumber': function (x,y) {
      return x.logn(y.toNumber());
    },

    'number | Complex, Quaternion': function (x,y) {
      return y.nonQuaternionOp([x,y], y.logn);
    },
