...
function factory (type, config, load, typed) {
   ...
   *    multiply
   *
   * @param  {number | BigNumber | Fraction | Complex | Unit | Array | Matrix | Quaternion} x   Numerator
   * @param  {number | BigNumber | Fraction | Complex | Array | Matrix | Quaternion} y          Denominator
   * @return {number | BigNumber | Fraction | Complex | Unit | Array | Matrix | Quaternion}     Quotient, `x / y`
   */
