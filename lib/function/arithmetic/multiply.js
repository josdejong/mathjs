...
function factory (type, config, load, typed) {
   ...
   *    divide
   *
   * @param  {number | BigNumber | Fraction | Complex | Unit | Array | Matrix | Quarternion} x First value to multiply
   * @param  {number | BigNumber | Fraction | Complex | Unit | Array | Matrix | Quarternion} y Second value to multiply
   * @return {number | BigNumber | Fraction | Complex | Unit | Array | Matrix | Quarternion} Multiplication of `x` and `y`
   */
  var multiply = typed('multiply', extend({
    ...
    'Quarternion, Quarternion | Complex': function (x,y) {
      return x.mul(y);
    },

    'Complex, Quarternion': function (x,y) {
      return y.reverseOrderMultiply(x);
    },

    'Quarternion, number': function (x,y) {
      return x.mul({r:y});
    },

    'number, Quarternion': function (x,y) {
      return y.reverseOrderMultiply({r:x});
    }
