...
function factory (type, config, load, typed) {
  ...
  var dotMultiply = typed('dotMultiply', {
      ...
      switch (x.storage()) {
        ...
        default:
          switch (y.storage()) {
            ...
            default:
              // dense .* dense
              c = elementWiseOperations.algorithm12(x, y, multiplyScalar);
              break;
          }
          break;
      }
    ...
    'Matrix, any': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm10(x, y, multiplyScalar, false);
          break;
        default:
          c = elementWiseOperations.algorithm13(x, y, multiplyScalar, false);
          break;
      }
      return c;
    },
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm10(y, x, multiplyScalar, true);
          break;
        default:
          c = elementWiseOperations.algorithm13(y, x, multiplyScalar, true);
          break;
      }
      return c;
    },
    ...
    'Array, any': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm13(matrix(x), y, multiplyScalar, false).valueOf();
    },

    'any, Array': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm13(matrix(y), x, multiplyScalar, true).valueOf();
    }
  });
