...
function factory (type, config, load, typed) {
   ...
   *
   * @param  {number | BigNumber | Fraction | Complex | Unit | Array | Matrix | Quaternion} x Left hand value
   * @param  {number | BigNumber | Fraction | Complex | Unit | Array | Matrix | Quaternion} y Right hand value
