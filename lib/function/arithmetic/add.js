...
function factory (type, config, load, typed) {
   ...
   *    subtract
   *
   * @param  {number | BigNumber | Fraction | Complex | Unit | Array | Matrix | Quarternion} x First value to add
   * @param  {number | BigNumber | Fraction | Complex | Unit | Array | Matrix | Quarternion} y Second value to add
   * @return {number | BigNumber | Fraction | Complex | Unit | Array | Matrix | Quarternion} Sum of `x` and `y`
   */
