...
function factory (type, config, load, typed) {
  ...
  var add = typed('add', {
      ...
      switch (x.storage()) {
        ...
        default:
          switch (y.storage()) {
            ...
            default:
              // dense + dense
              c = elementWiseOperations.algorithm11(x, y, addScalar, false);
              break;
          }
          break;
      }
    ...
    'Matrix, any': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm8(x, y, addScalar, false);
          break;
        default:
          c = elementWiseOperations.algorithm12(x, y, addScalar, false);
          break;
      }
      return c;
    },
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm8(y, x, addScalar, true);
          break;
        default:
          c = elementWiseOperations.algorithm12(y, x, addScalar, true);
          break;
      }
      return c;
    },
    ...
    'Array, any': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm12(matrix(x), y, addScalar, false).valueOf();
    },

    'any, Array': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm12(matrix(y), x, addScalar, true).valueOf();
    }
  });
