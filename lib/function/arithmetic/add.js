...
function factory (type, config, load, typed) {
   ...
   *    subtract
   *
   * @param  {number | BigNumber | Fraction | Complex | Unit | Array | Matrix | Quaternion} x First value to add
   * @param  {number | BigNumber | Fraction | Complex | Unit | Array | Matrix | Quaternion} y Second value to add
   * @return {number | BigNumber | Fraction | Complex | Unit | Array | Matrix | Quaternion} Sum of `x` and `y`
   */
