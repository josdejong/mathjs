...
function factory (type, config, load, typed) {
  ...
  var add = typed('add', {
      ...
      switch (x.storage()) {
        ...
        default:
          switch (y.storage()) {
            ...
            default:
              // dense + dense
              c = elementWiseOperations.algorithm10(x, y, addScalar, false);
              break;
          }
          break;
      }
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          ...
          break;
        default:
          c = elementWiseOperations.algorithm11(y, x, addScalar, true);
          break;
      }
      return c;
    },
    ...
    'Array, any': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm11(matrix(x), y, addScalar, false).valueOf();
    },

    'any, Array': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm11(matrix(y), x, addScalar, true).valueOf();
    }
  });
