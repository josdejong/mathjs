...
function factory (type, config, load, typed) {
  ...
  var add = typed('add', {
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          ...
          break;
        default:
          c = elementWiseOperations.algorithm10(y, x, addScalar, true);
          break;
      }
      return c;
    },
    ...
    'Array, any': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm10(matrix(x), y, addScalar, false).valueOf();
    },

    'any, Array': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm10(matrix(y), x, addScalar, true).valueOf();
    }
  });
