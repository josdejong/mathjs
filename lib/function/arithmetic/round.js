...
function factory (type, config, load, typed) {
  ...
  var round = typed('round', {
    ...
    'Matrix, number | BigNumber': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          c = algorithm10(x, y, round, false);
          break;
        default:
          c = algorithm13(x, y, round, false);
          break;
      }
      return c;
    },
    ...
    'number | Complex | BigNumber, Matrix': function (x, y) {
      ...
      if (!equalScalar(x, 0)) {
        ...
        switch (y.storage()) {
          case 'sparse':
            c = algorithm11(y, x, round, true);
            break;
          default:
            c = algorithm13(y, x, round, true);
            break;
        }
        return c;
      }
    ...
    'Array, number | BigNumber': function (x, y) {
      ...
      return algorithm13(matrix(x), y, round, false).valueOf();
    },

    'number | Complex | BigNumber, Array': function (x, y) {
      // use matrix implementation
      return algorithm13(matrix(y), x, round, true).valueOf();
    }
  });
