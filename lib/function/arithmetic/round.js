  ...
  math.round = function round(x, n) {
    ...
    if (n == undefined) {
      ...
      if (n instanceof BigNumber) {
        if (isNumber(x)) {
          return round(new BigNumber(x), parseFloat(n.valueOf()));
        }
        else if (isBoolean(x)) {
          return round(new BigNumber(Number(x)), parseFloat(n.valueOf()));
        }
        else {
          return round(x, parseFloat(n.valueOf()));
        }
      }
