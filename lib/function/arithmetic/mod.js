...
function factory (type, config, load, typed) {
  ...
  var mod = typed('mod', {
    ...
    'Matrix, any': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          c = algorithm10(x, y, mod, false);
          break;
        default:
          c = algorithm13(x, y, mod, false);
          break;
      }
      return c;
    },
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = algorithm11(y, x, mod, true);
          break;
        default:
          c = algorithm13(y, x, mod, true);
          break;
      }
      return c;
    },
    ...
    'Array, any': function (x, y) {
      // use matrix implementation
      return algorithm13(matrix(x), y, mod, false).valueOf();
    },

    'any, Array': function (x, y) {
      // use matrix implementation
      return algorithm13(matrix(y), x, mod, true).valueOf();
    }
  });
