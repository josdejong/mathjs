...
function factory (type, config, load, typed) {
   ...
   *    divide
   *
   * @param  {Number | BigNumber | Fraction | Boolean | Array | Matrix | null} x Dividend
   * @param  {Number | BigNumber | Fraction | Boolean | Array | Matrix | null} y Divisor
