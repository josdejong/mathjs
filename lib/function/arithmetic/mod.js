...
function factory (type, config, load, typed) {
  ...
  var mod = typed('mod', {
      ...
      switch (x.storage()) {
        ...
        default:
          switch (y.storage()) {
            ...
            default:
              // mod(dense, dense)
              c = elementWiseOperations.algorithm12(x, y, mod);
              break;
          }
          break;
      }
    ...
    'Matrix, any': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm10(x, y, mod, false);
          break;
        default:
          c = elementWiseOperations.algorithm13(x, y, mod, false);
          break;
      }
      return c;
    },
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm11(y, x, mod, true);
          break;
        default:
          c = elementWiseOperations.algorithm13(y, x, mod, true);
          break;
      }
      return c;
    },
    ...
    'Array, any': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm13(matrix(x), y, mod, false).valueOf();
    },

    'any, Array': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm13(matrix(y), x, mod, true).valueOf();
    }
  });
