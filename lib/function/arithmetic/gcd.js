...
function factory (type, config, load, typed) {
  ...
  var gcd = typed('gcd', {
      ...
      switch (x.storage()) {
        ...
        default:
          switch (y.storage()) {
            ...
            default:
              // dense + dense
              c = elementWiseOperations.algorithm11(x, y, gcd);
              break;
          }
          break;
      }
    ...
    'Matrix, number | BigNumber': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm8(x, y, gcd, false);
          break;
        default:
          c = elementWiseOperations.algorithm12(x, y, gcd, false);
          break;
      }
      return c;
    },
    ...
    'number | BigNumber, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm8(y, x, gcd, true);
          break;
        default:
          c = elementWiseOperations.algorithm12(y, x, gcd, true);
          break;
      }
      return c;
    },
    ...
    'Array, number | BigNumber': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm12(matrix(x), y, gcd, false).valueOf();
    },

    'number | BigNumber, Array': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm12(matrix(y), x, gcd, true).valueOf();
    },
