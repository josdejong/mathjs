...
function factory (type, config, load, typed) {
  ...
  var gcd = typed('gcd', {
    ...
    'Matrix, number | BigNumber': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          c = algorithm09(x, y, gcd, false);
          break;
        default:
          c = algorithm13(x, y, gcd, false);
          break;
      }
      return c;
    },
    ...
    'number | BigNumber, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = algorithm09(y, x, gcd, true);
          break;
        default:
          c = algorithm13(y, x, gcd, true);
          break;
      }
      return c;
    },
    ...
    'Array, number | BigNumber': function (x, y) {
      // use matrix implementation
      return algorithm13(matrix(x), y, gcd, false).valueOf();
    },

    'number | BigNumber, Array': function (x, y) {
      // use matrix implementation
      return algorithm13(matrix(y), x, gcd, true).valueOf();
    },
