...
function factory (type, config, load, typed) {
  ...
  var gcd = typed('gcd', {
      ...
      switch (x.storage()) {
        case 'sparse':
          switch (y.storage()) {
            case 'sparse':
              // sparse + sparse
              c = elementWiseOperations.algorithm4(x, y, gcd);
              break;
            default:
              // sparse + dense
              c = elementWiseOperations.algorithm1(y, x, gcd, true);
              break;
          }
          break;
        default:
          switch (y.storage()) {
            case 'sparse':
              // dense + sparse
              c = elementWiseOperations.algorithm1(x, y, gcd, false);
              break;
            default:
              // dense + dense
              c = elementWiseOperations.algorithm12(x, y, gcd);
              break;
          }
          break;
      }
    ...
    'Matrix, number | BigNumber': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm9(x, y, gcd, false);
          break;
        default:
          c = elementWiseOperations.algorithm13(x, y, gcd, false);
          break;
      }
      return c;
    },
    ...
    'number | BigNumber, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm9(y, x, gcd, true);
          break;
        default:
          c = elementWiseOperations.algorithm13(y, x, gcd, true);
          break;
      }
      return c;
    },
    ...
    'Array, number | BigNumber': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm13(matrix(x), y, gcd, false).valueOf();
    },

    'number | BigNumber, Array': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm13(matrix(y), x, gcd, true).valueOf();
    },
