...
function factory(type, config, load, typed) {
   ...
   *
   * @param  {Number | BigNumber | Fraction | Boolean | Complex | Unit | null} x   Numerator
   * @param  {Number | BigNumber | Fraction | Boolean | Complex | null} y          Denominator
