...
function factory (type, config, load, typed) {
   ...
   *     sqrt, pow
   *
   * @param {number | BigNumber | Array | Matrix | Complex, | Quaternion} a
   *              Value for which to calculate the nth root
   * @param {number | BigNumber} [root=2]    The root.
   * @return {number | Complex | Array | Matrix | Quaternion} Returns the nth root of `a`
   */
