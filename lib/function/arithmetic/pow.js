...
function factory (type, config, load, typed) {
   ...
   *
   * @param  {number | BigNumber | Complex | Array | Matrix | Quaternion} x  The base
   * @param  {number | BigNumber | Complex | Quaternion} y                   The exponent
   * @return {number | BigNumber | Complex | Array | Matrix | Quaternion} The value of `x` to the power `y`
   */
  var pow = typed('pow', {
    'number, number': _pow,
    ...
    'number, Quaternion': function (x,y) {
      return y.nonQuaternionOp([x,y], 'pow');
    }
