...
function factory (type, config, load, typed) {
   ...
   *
   * @param  {number | BigNumber | Complex | Array | Matrix | Quarternion} x  The base
   * @param  {number | BigNumber | Complex | Quarternion} y                   The exponent
   * @return {number | BigNumber | Complex | Array | Matrix | Quarternion} The value of `x` to the power `y`
   */
  var pow = typed('pow', {
    'number, number': _pow,
