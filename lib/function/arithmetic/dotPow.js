...
function factory (type, config, load, typed) {
  ...
  var dotPow = typed('dotPow', {
    ...
    'Matrix, any': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          c = algorithm10(x, y, dotPow, false);
          break;
        default:
          c = algorithm13(x, y, dotPow, false);
          break;
      }
      return c;
    },
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = algorithm11(y, x, dotPow, true);
          break;
        default:
          c = algorithm13(y, x, dotPow, true);
          break;
      }
      return c;
    },
    ...
    'Array, any': function (x, y) {
      // use matrix implementation
      return algorithm13(matrix(x), y, dotPow, false).valueOf();
    },

    'any, Array': function (x, y) {
      // use matrix implementation
      return algorithm13(matrix(y), x, dotPow, true).valueOf();
    }
  });
