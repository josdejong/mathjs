...
function factory (type, config, load, typed) {
   ...
   *    pow, sqrt, multiply
   *
   * @param  {number | BigNumber | Complex | Unit | Array | Matrix | Quarternion} x  The base
   * @param  {number | BigNumber | Complex | Unit | Array | Matrix}               y  The exponent
   * @return {number | BigNumber | Complex | Unit | Array | Matrix | Quarternion} The value of `x` to the power `y`
   */
