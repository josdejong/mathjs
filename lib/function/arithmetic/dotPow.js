...
function factory (type, config, load, typed) {
  ...
  var dotPow = typed('dotPow', {
      ...
      switch (x.storage()) {
        ...
        default:
          switch (y.storage()) {
            ...
            default:
              // dense .^ dense
              c = elementWiseOperations.algorithm12(x, y, pow);
              break;
          }
          break;
      }
    ...
    'Matrix, any': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm10(x, y, dotPow, false);
          break;
        default:
          c = elementWiseOperations.algorithm13(x, y, dotPow, false);
          break;
      }
      return c;
    },
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm11(y, x, dotPow, true);
          break;
        default:
          c = elementWiseOperations.algorithm13(y, x, dotPow, true);
          break;
      }
      return c;
    },
    ...
    'Array, any': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm13(matrix(x), y, dotPow, false).valueOf();
    },

    'any, Array': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm13(matrix(y), x, dotPow, true).valueOf();
    }
  });
