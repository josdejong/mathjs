...
function factory (type, config, load, typed) {
   ...
   *    pow, sqrt, multiply
   *
   * @param  {number | BigNumber | Complex | Unit | Array | Matrix | Quaternion} x  The base
   * @param  {number | BigNumber | Complex | Unit | Array | Matrix}               y  The exponent
   * @return {number | BigNumber | Complex | Unit | Array | Matrix | Quaternion} The value of `x` to the power `y`
   */
