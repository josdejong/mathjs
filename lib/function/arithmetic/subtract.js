...
function factory (type, config, load, typed) {
   ...
   *    add
   *
   * @param  {number | BigNumber | Fraction | Complex | Unit | Array | Matrix | Quarternion} x
   *            Initial value
   * @param  {number | BigNumber | Fraction | Complex | Unit | Array | Matrix | Quarternion} y
   *            Value to subtract from `x`
   * @return {number | BigNumber | Fraction | Complex | Unit | Array | Matrix | Quarternion}
  ...
  var subtract = typed('subtract', {
    ...
    'Complex, Quarternion': function (x,y) {
      y.reverseOrderSubtract(x);
    },

    'Quarternion, number': function (x,y) {
      return x.subtract({r:y});
    },
