...
function factory (type, config, load, typed) {
   ...
   *    add
   *
   * @param  {number | BigNumber | Fraction | Complex | Unit | Array | Matrix | Quaternion} x
   *            Initial value
   * @param  {number | BigNumber | Fraction | Complex | Unit | Array | Matrix | Quaternion} y
   *            Value to subtract from `x`
   * @return {number | BigNumber | Fraction | Complex | Unit | Array | Matrix | Quaternion}
  ...
  var subtract = typed('subtract', {
    ...
    'Complex, Quaternion': function (x,y) {
      return y.nonQuaternionOp([x,y], 'subtract');
    },
