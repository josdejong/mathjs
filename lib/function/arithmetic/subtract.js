...
function factory (type, config, load, typed) {
  ...
  var subtract = typed('subtract', {
    ...
    'Matrix, any': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          ...
          c = algorithm09(x, unaryMinus(y), addScalar);
          break;
        default:
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = algorithm09(y, x, subtract, true);
          break;
        default:
          c = algorithm13(y, x, subtract, true);
          break;
      }
      return c;
    },
    ...
    'Array, any': function (x, y) {
      // use matrix implementation
      return algorithm13(matrix(x), y, subtract, false).valueOf();
    },

    'any, Array': function (x, y) {
      // use matrix implementation
      return algorithm13(matrix(y), x, subtract, true).valueOf();
    }
  });
