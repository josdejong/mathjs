...
function factory (type, config, load, typed) {
  ...
  var subtract = typed('subtract', {
    ...
    'Matrix, any': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          ...
          c = elementWiseOperations.algorithm9(x, unaryMinus(y), addScalar);
          break;
        default:
          c = elementWiseOperations.algorithm13(x, y, subtract);
          break;
      }
      return c;
    },
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm9(y, x, subtract, true);
          break;
        default:
          c = elementWiseOperations.algorithm13(y, x, subtract, true);
          break;
      }
      return c;
    },
    ...
    'Array, any': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm13(matrix(x), y, subtract, false).valueOf();
    },

    'any, Array': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm13(matrix(y), x, subtract, true).valueOf();
    }
  });
