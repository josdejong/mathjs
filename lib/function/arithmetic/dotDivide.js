...
function factory (type, config, load, typed) {
  ...
  var dotDivide = typed('dotDivide', {
      ...
      switch (x.storage()) {
        ...
        default:
          switch (y.storage()) {
            ...
            default:
              // dense ./ dense
              c = algorithm12(x, y, divideScalar);
              break;
          }
          break;
      }
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = algorithm11(y, x, divideScalar, true);
          break;
        default:
          c = algorithm13(y, x, divideScalar, true);
          break;
      }
      return c;
    },
    ...
    'any, Array': function (x, y) {
      // use matrix implementation
      return algorithm13(matrix(y), x, divideScalar, true).valueOf();
    }
  });
