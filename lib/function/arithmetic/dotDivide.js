...
function factory (type, config, load, typed) {
  ...
  var dotDivide = typed('dotDivide', {
      ...
      switch (x.storage()) {
        ...
        default:
          switch (y.storage()) {
            ...
            default:
              // dense ./ dense
              c = elementWiseOperations.algorithm12(x, y, divideScalar);
              break;
          }
          break;
      }
    ...
    'Matrix, any': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm10(x, y, divideScalar, false);
          break;
        default:
          c = elementWiseOperations.algorithm13(x, y, divideScalar, false);
          break;
      }
      return c;
    },
    ...
    'any, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = elementWiseOperations.algorithm11(y, x, divideScalar, true);
          break;
        default:
          c = elementWiseOperations.algorithm13(y, x, divideScalar, true);
          break;
      }
      return c;
    },
    ...
    'Array, any': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm13(matrix(x), y, divideScalar, false).valueOf();
    },

    'any, Array': function (x, y) {
      // use matrix implementation
      return elementWiseOperations.algorithm13(matrix(y), x, divideScalar, true).valueOf();
    }
  });
