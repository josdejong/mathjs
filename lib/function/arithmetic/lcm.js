...
function factory (type, config, load, typed) {
  ...
  var lcm = typed('lcm', {
    ...
    'Matrix, number | BigNumber': function (x, y) {
      ...
      switch (x.storage()) {
        case 'sparse':
          c = algorithm10(x, y, lcm, false);
          break;
        default:
          c = algorithm13(x, y, lcm, false);
          break;
      }
      return c;
    },
    ...
    'number | BigNumber, Matrix': function (x, y) {
      ...
      switch (y.storage()) {
        case 'sparse':
          c = algorithm10(y, x, lcm, true);
          break;
        default:
          c = algorithm13(y, x, lcm, true);
          break;
      }
      return c;
    },
    ...
    'Array, number | BigNumber': function (x, y) {
      // use matrix implementation
      return algorithm13(matrix(x), y, lcm, false).valueOf();
    },

    'number | BigNumber, Array': function (x, y) {
      // use matrix implementation
      return algorithm13(matrix(y), x, lcm, true).valueOf();
    },
