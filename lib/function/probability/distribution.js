  ...
  function distribution(name) {
    ...
    return (function(distribution) {
      ...
      var randFunctions = {
        ...
        pickRandom: function(possibles, arg2, arg3) {
          var number, weights, single;

          if (arguments.length < 1 || arguments.length > 3) {
            throw new ArgumentsError('pickRandom', arguments.length, 1, 3);
          }
          ...
          if (arguments.length == 3) {
            if (Array.isArray(arg3) ) {
              if (typeof number === 'undefined') {
                // two arrays were passed
                throw new TypeError('Invalid arguments in function pickRandom')
              }
              weights = arg3;
            } else if (isInteger(arg3)) {
              if (typeof weights === 'undefined') {
                // two ints were passed
                throw new TypeError('Invalid arguments in function pickRandom')
              }
              number = arg3;
            } else {
          ...
          if (typeof weights !== 'undefined') {
            ...
            for (var i = 0, len = weights.length; i < len; i++) {
              if (!isInteger(weights[i])) {
                throw new Error('Weights must be an array of integers');
              }
