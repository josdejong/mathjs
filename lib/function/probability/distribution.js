...
function factory (type, config, load, typed) {
  ...
  function distribution(name) {
    ...
    return (function(distribution) {
      ...
      var randFunctions = {
        ...
        random: function(arg1, arg2, arg3) {
            switch (arguments.length) {
              case 0:
                return _randomHelper(_random);
              case 1:
                return _randomHelper(_random, arg1);
              case 2:
                return _randomHelper(_random, arg1, arg2);
              case 3:
                return _randomHelper(_random, arg1, arg2, arg3);
              default:
        ...
        randomInt: function(arg1, arg2, arg3) {
            switch (arguments.length) {
              case 1:
                return _randomHelper(_randomInt, arg1);
              case 2:
                return _randomHelper(_randomInt, arg1, arg2);
              case 3:
                return _randomHelper(_randomInt, arg1, arg2, arg3);
              default:
      ...
      var _randomHelper = typed({
        'function': function(randFunc) {
          return randFunc(0, 1);
        },
        'function, number | Array': function(randFunc, arg) {
          var min = 0;

          if (isCollection(arg)) {
            var size = arg;
            var max = 1;
            var res = _randomDataForMatrix(size.valueOf(), min, max, randFunc);
            return (size && size.isMatrix === true) ? matrix(res) : res;
          }

          return randFunc(0, arg);
        },
        'function, number | Array, number': function(randFunc, arg1, arg2) {
          ...
          return randFunc(arg1, arg2);
        },
        'function, Array, number, number': function(randFunc, size, min, max) {
          var res = _randomDataForMatrix(size.valueOf(), min, max, randFunc);
          return (size && size.isMatrix === true) ? matrix(res) : res;
        }
      });
