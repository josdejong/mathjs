...
module.exports = {
  NO_CHANGE: "no change",
  REMOVE_PARENS_ROOT_NODE: "remove unnecessary parens around root node",
  REMOVE_PARENS_GENERAL: "remove unnecessary parens",
  ...
  DIVIDE_POLY_TERM: "perform division within a polynomial term",
}
