      ...
      case 'ParenthesisNode':
        ...
        if (contentNodeStatus.hasChanged) {
          ...
          return new NodeStatus(
            node, true, contentNodeStatus.changeType);
        }
        // Then try simplifying the content, which has to be an OperatorNode
        // (because of removeUnnecessaryParens)
        return simplifyOperations(node.content);
      case 'OperatorNode':
