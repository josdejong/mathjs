...
function solveEquation(equation, debug=false) {
  ...
  do {
    ...
    console.log(Equation.prettyPrintEquation(equation))
...
function step(equation, symbolName) {
  ...
  // console.log(JSON.stringify(equation.leftNode, null, 2));
  // console.log(JSON.stringify(equation.rightNode, null, 2));
