...
// the steps to get to the solution, and a string representation of the solution.
// The possible solutions include solving for x, and the result of comparing
// values
...
// simplify leftNode and rightNode and returns the simplification steps
...
function solveConstantEquation(equation) {
  ...
  if (!Util.isConstantOrConstantFraction(equation.leftNode) || !Util.isConstantOrConstantFraction(equation.rightNode)) {
