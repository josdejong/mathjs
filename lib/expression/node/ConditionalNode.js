...
function factory (type, config, load, typed) {
  ...
  var Complex   = load(require('../../type/Complex'));
  var Unit      = load(require('../../type/Unit'));
  ...
  ConditionalNode.prototype._toString = function () {
    ...
    var condition = this.condition._toString();
    ...
    var trueExpr = this.trueExpr._toString();
    ...
    var falseExpr = this.falseExpr._toString();
