...
function factory (type, config, load, typed, math) {
  ...
  SymbolNode.prototype.toHTML = function(options) {
    ...
    if (this.name == "true" || this.name == "false") {
	  return '<span class="math-symbol math-boolean">' + this.name + '</span>' + comment;
	}
	else if (this.name == "i") {
	  return '<span class="math-symbol math-imaginary-symbol">' + this.name + '</span>' + comment;
	}
	else if (this.name == "Infinity") {
	  return '<span class="math-symbol math-infinity-symbol">' + this.name + '</span>' + comment;
	}
	else if (this.name == "NaN") {
	  return '<span class="math-symbol math-nan-symbol">' + this.name + '</span>' + comment;
	}
	else if (this.name == "null") {
	  return '<span class="math-symbol math-null-symbol">' + this.name + '</span>' + comment;
	}
	else if (this.name == "uninitialized") {
	  return '<span class="math-symbol math-uninitialized-symbol">' + this.name + '</span>' + comment;
	}
	
	return '<span class="math-symbol">' + this.name + '</span>' + comment;
  };
