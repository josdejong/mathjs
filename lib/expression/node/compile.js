 ...
 */
exports.register = function (type, compileFunction) {
  if (compileFunctions[type] === undefined) {
    compileFunctions[type] = compileFunction;
  }
  else {
    // TODO: throw error instead. change compile into a factory function
    console.warn('Cannot register type "' + type + '": already exists')
 ...
 */
exports.compile = function (node, defs, args) {
