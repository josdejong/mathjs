...
function factory (type, config, load, typed) {
   ...
   * @return {boolean}
   */
  IndexNode.prototype.isProperty = function () {
   ...
   * @return {string | null}
   */
  IndexNode.prototype.getPropertyName = function () {
    return this.isProperty() ? this.ranges[0].value : null;
  };
  ...
  IndexNode.prototype.needsSize = function () {
    return this.ranges.some(function (range) {
      return range.isRangeNode ? range.needsEnd() : null;
    });
  };
