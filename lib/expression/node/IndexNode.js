...
function factory (type, config, load, typed) {
  ...
  IndexNode.prototype.toHTML = function (options) {
	...
	if (this.dotNotation) {
	  return '<span class="math-operator math-accessor-operator">.</span>' + '<span class="math-symbol math-variable math-property">' + this.getObjectProperty() + '</span>' + comment;}
	else {
	  return '<span class="math-parenthesis math-square-parenthesis">[</span>' + this.dimensions.join('<span class="math-separator">,</span>') + '<span class="math-parenthesis math-square-parenthesis">]</span>' + comment;}
  };
