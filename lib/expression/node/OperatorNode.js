    ...
    switch (args.length) {
      case 1: //unary operators
        ...
        if (assoc === 'right') { //prefix operator
          ...
          return operand + '<span class="math-operator math-unary-operator math-righthand-unary-operator">' + this.op + '</span>';
        }
      ...
      default:
        //fallback to formatting as a function call
        return '<span class="math-function">' + this.fn + '</span>' + '<span class="math-parenthesis math-round-parenthesis">(</span>' + this.args.join('<span class="math-separator">,</span>') + '<span class="math-parenthesis math-round-parenthesis">)</span>';
    }
  };
