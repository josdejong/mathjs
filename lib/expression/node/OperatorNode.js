...
OperatorNode.prototype.getIdentifier = function() {
  if ((typeof this.fn !== 'string') || (this.fn === '')) {
    throw new Error('Can\'t create an identifier for OperatorNode, missing function name.');
  }
  return this.type + ':' + this.fn;
};

/**
 * Get the precedence of this OperatorNode.
 * @return {Number}
 */
OperatorNode.prototype.getPrecedence = function () {
  return precedence.getPrecedence(this);
};
