  ...
  OperatorNode.prototype.toHTML = function (options) {
    ...
    switch (args.length) {
      case 1: //unary operators
        ...
        if (assoc === 'right') { //prefix operator
          return '<span class="math-operator math-unary-operator math-lefthand-unary-operator">' + this.op + '</span>' + operand + comment;
        }
        else if (assoc === 'left') { //postfix
          return operand + '<span class="math-operator math-unary-operator math-righthand-unary-operator">' + this.op + '</span>' + comment;
        }
      ...
      case 2: //binary operators
        ...
        if (this.implicit && (this.getIdentifier() === 'OperatorNode:multiply') && (implicit == 'hide')) {
          return lhs + '<span class="math-operator math-binary-operator math-implicit-binary-operator"></span>' + rhs + comment;
        }

        return lhs + '<span class="math-operator math-binary-operator math-explicit-binary-operator">' + this.op + '</span>' + rhs + comment;

      default:
        //fallback to formatting as a function call
        return '<span class="math-function">' + this.fn + '</span>' + '<span class="math-parenthesis math-round-parenthesis">(</span>' + this.args.join('<span class="math-separator">,</span>') + '<span class="math-parenthesis math-round-parenthesis">)</span>' + comment;
    }
  };
