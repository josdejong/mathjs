...
function factory (type, config, load, typed) {
  ...
  ConstantNode.prototype.toHTML = function (options) {
    switch (this.valueType) {
	  case 'number':
	    return '<span class="math-number">' + this.value + '</span>';
      case 'string':
	    return '<span class="math-string">' + this.value + '</span>';
      case 'boolean':
	    return '<span class="math-boolean">' + this.value + '</span>';
      case 'null':
	    return '<span class="math-null-symbol">' + this.value + '</span>';
      case 'undefined':
	    return '<span class="math-undefined">' + this.value + '</span>';

      default:
        return '<span class="math-symbol">' + this.value + '</span>';
    }
  };
