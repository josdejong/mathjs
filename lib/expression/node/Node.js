...
function factory (type, config, load, typed) {
  ...
  /**
   * Merge global with local config.
  ...
  function mergeConfig (globalConfig, localConfig) {
    var mergedConfig = object.clone(globalConfig);
    return object.extend(mergedConfig, localConfig);
  }
  ...
  Node.prototype.toString = function (localConfig, callback) {
    if (localConfig) {
      localConfig = mergeConfig(config, localConfig);
    }
    else {
      localConfig = config;
    }
