...
/**
 * Get the precedence of the current Node ( Infinity if not specified ).
 * Higher number for higher precedence, starting with 0.
 * @return {Number} precedence
 */
Node.prototype.getPrecedence = function() {
  ...
  //return infinity for non-specified nodes like FunctionNode
  return Infinity;
};
