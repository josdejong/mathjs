...
ParamsNode.prototype.eval = function() {
  ...
  if (typeof obj === 'function') {
    ...
    // evaluate the values of context parameter 'end' when applicable
 ...
 * @private
 */
ParamsNode.prototype._compile = function (math) {
  // TODO: implement support for matrix indexes and ranges
  var params = this.params.map(function (param) {
    return param._compile(math);
  });

  return this.object._compile(math) + '(' + params.join(', ') + ')';
};
