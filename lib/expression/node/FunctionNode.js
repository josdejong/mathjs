...
function factory (type, config, load, typed, math) {
  ...
  /**
   * merge function arguments into scope before passing to the function.
   * This is needed when the function contains function calls to functions
   * with `rawArgs=true`.
   * @param {Object} defs     Object which can be used to define functions
   *                          or constants globally available for the compiled
   *                          expression
