...
function factory (type, config, load, typed, math) {
  ...
  function FunctionNode(fn, args) {
    ...
    Object.defineProperty(this, 'name', {
      get: function () {
        return this.fn.isSymbolNode ? this.fn.name : 'anonymous';
        // TODO: read property name from AccessorNode?
      }.bind(this),
      set: function () {
  ...
  FunctionNode.prototype._compile = function (defs, args) {
    ...
    if (this.fn.isAccessorNode && this.fn.index.isProperty()) {
      // execute the function with the right context: the object of the AccessorNode
      argsName = this._getUniqueArgumentsName(defs);
      defs[argsName] = this.args;

      var jsObject = this.fn.object._compile(defs, args);
      var prop = this.fn.index.getPropertyName();
