...
function factory (type, config, load, typed) {
  ...
  ArrayNode.prototype.toHTML = function(options) {
    ...
    return '<span class="math-parenthesis math-square-parenthesis">[</span>' + items.join('<span class="math-separator">,</span>') + '<span class="math-parenthesis math-square-parenthesis">]</span>' + comment;
  };
