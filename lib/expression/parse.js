    ...
    while(true) {
      ...
      if(token === '/' && type.isConstantNode(last)) {
        ...
        if(token_type === TOKENTYPE.NUMBER) {
          ...
          var temp2_token_type = token_type;
          var temp2_token = token;
          var temp2_comment = comment;
          var temp2_index = index;
          var temp2_c = c;
        
          // Look ahead again
          getTokenSkipNewline();
          
          // Match the "symbol" part of the pattern
          if(token_type === TOKENTYPE.SYMBOL) {
            // We've matched the pattern "number / number symbol".

            // Rewind once and only build the "number / number" node
            token_type = temp2_token_type;
            token = temp2_token;
            comment = temp2_comment;
            index = temp2_index;
            c = temp2_c;
