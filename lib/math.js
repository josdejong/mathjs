...
function create (config) {
  ...
  // matrix formats
  var CcsFormat = require('./type/matrix/CcsFormat')(math, _config);
  var CrsFormat = require('./type/matrix/CrsFormat')(math, _config);
  var DenseFormat = require('./type/matrix/DenseFormat')(math, _config)

  // matrix format registry
  math.type.Matrix.format = {
    ccs: CcsFormat,
    crs: CrsFormat,
    dense: DenseFormat,
    'default': DenseFormat
