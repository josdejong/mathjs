...
function create (config) {
  ...
  typed.conversions = [
    {
      ...
      to: 'BigNumber',
      convert: function (x) {
        return toBigNumber(x, BigNumber);
      }
    }, {
      from: 'boolean',
      to: 'number',
  ...
  math.abs = require('./function/arithmetic/abs');
  math.add = require('./function/arithmetic/add');
  ...
  math.exp = require('./function/arithmetic/exp');
  ...
  math.multiply = require('./function/arithmetic/multiply');
  ...
  math.sqrt = require('./function/arithmetic/sqrt');
  require('./function/arithmetic/square')(math, _config);
  math.subtract = require('./function/arithmetic/subtract');
  math.unaryMinus = require('./function/arithmetic/unaryMinus');
  ...
  math.det = require('./function/matrix/det');
  ...
  math.min = require('./function/statistics/min');
  ...
  math.sum = require('./function/statistics/sum');
