...
function factory (config) {
  ...
  require('./expression/transform/concat')(math, _config);
  require('./expression/transform/index')(math, _config);
  require('./expression/transform/range')(math, _config);
  // TODO: transform for subset
