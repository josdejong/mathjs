...
function mathjs (settings) {
  ...
  require('./function/arithmetic/compare.js')(math, _settings);
  ...
  require('./function/statistics/median.js')(math, _settings);
  require('./function/statistics/prod.js')(math, _settings);
  require('./function/statistics/std.js')(math, _settings);
  require('./function/statistics/sum.js')(math, _settings);
  require('./function/statistics/var.js')(math, _settings);
