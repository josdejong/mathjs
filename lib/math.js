...
function create (config) {
  ...
  math.max    = require('./function/statistics/max')(_config);
  math.mean   = require('./function/statistics/mean')(_config);
  math.median = require('./function/statistics/median')(_config);
  math.min    = require('./function/statistics/min')(_config);
  math.prod   = require('./function/statistics/prod')(_config);
  math.std    = require('./function/statistics/std')(_config);
  math.sum    = require('./function/statistics/sum')(_config);
  math['var'] = require('./function/statistics/var')(_config);

  // functions - trigonometry
  math.acos = require('./function/trigonometry/acos')(_config, math.type);
  math.acosh = require('./function/trigonometry/acosh')(_config, math.type);
  require('./function/trigonometry/acot')(math, _config);
  math.acoth = require('./function/trigonometry/acoth')(_config, math.type);
  require('./function/trigonometry/acsc')(math, _config);
  math.acsch = require('./function/trigonometry/acsch')(_config, math.type);
  require('./function/trigonometry/asec')(math, _config);
  math.asech = require('./function/trigonometry/asech')(_config, math.type);
  math.asin = require('./function/trigonometry/asin')(_config, math.type);
  math.asinh = require('./function/trigonometry/asinh')(_config, math.type);
  require('./function/trigonometry/atan')(math, _config);
  require('./function/trigonometry/atan2')(math, _config);
  math.atanh = require('./function/trigonometry/atanh')(_config, math.type);
  math.cos = require('./function/trigonometry/cos')(_config, math.type);
  math.cosh = require('./function/trigonometry/cosh')(_config, math.type);
  require('./function/trigonometry/cot')(math, _config);
  math.coth = require('./function/trigonometry/coth')(_config, math.type);
  require('./function/trigonometry/csc')(math, _config);
  math.csch = require('./function/trigonometry/csch')(_config, math.type);
  require('./function/trigonometry/sec')(math, _config);
  math.sech = require('./function/trigonometry/sech')(_config, math.type);
  require('./function/trigonometry/sin')(math, _config);
  math.sinh = require('./function/trigonometry/sinh')(_config, math.type);
  require('./function/trigonometry/tan')(math, _config);
  math.tanh = require('./function/trigonometry/tanh')(_config, math.type);
