...
exports.create = function create(type) {
  ...
  typed.types = [
    ...
    { type: 'OperatorNode',    test: function (x) { return x && x.isOperatorNode } },
    { type: 'ConstantNode',    test: function (x) { return x && x.isConstantNode } },
    { type: 'SymbolNode',      test: function (x) { return x && x.isSymbolNode } },
    { type: 'ParenthesisNode', test: function (x) { return x && x.isParenthesisNode } },
    { type: 'FunctionNode',    test: function (x) { return x && x.isFunctionNode } },

    { type: 'ArrayNode',                 test: function (x) { return x && x.isArrayNode } },
    { type: 'AssignmentNode',            test: function (x) { return x && x.isAssignmentNode } },
    { type: 'BlockNode',                 test: function (x) { return x && x.isBlockNode } },
    { type: 'ConditionalNode',           test: function (x) { return x && x.isConditionalNode } },
    { type: 'FunctionAssignmentNode',    test: function (x) { return x && x.isFunctionAssignmentNode } },
    { type: 'IndexNode',                 test: function (x) { return x && x.isIndexNode } },
    { type: 'RangeNode',                 test: function (x) { return x && x.isRangeNode } },
    { type: 'UpdateNode',                test: function (x) { return x && x.isUpdateNode } },
    { type: 'Node',                      test: function (x) { return x && x.isNode } },
  ];
