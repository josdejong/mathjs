...
exports.create = function create(type) {
  ...
  typed.conversions = [
    ...
    //     return new type.Quaternion(Complex);
    //   }
    // }, {
    //   from: 'number',
    //   to: 'Quaternion',
    //   convert: function (number) {
    //     return new type.Quaternion(number,0,0,0);
    //   }
    // }, {
    //   from: 'BigNumber',
    //   to: 'Quaternion',
    //   convert: function (bignumber) {
    //     return new type.Quaternion(bignumber.toNumber(),0,0,0);
    //   }
    // }, {
    //   from: 'Fraction',
    //   to: 'Quaternion',
    //   convert: function (fraction) {
    //     return new type.Quaternion(fraction.toNumber(),0,0,0);
    //   }
    // }, {
    //   from: 'null',
    //   to: 'Quaternion',
    //   convert: function () {
    //     return new type.Quaternion();
    //   }
    // }
  ];
