...
exports.create = function create(type) {
  ...
  typed.types = [
    ...
    { name: 'Quarternion',          test: function (x) { return x && x.isQuarternion; } },
  ...
  typed.conversions = [
    ...
    //}, {
      ...
      from: 'Complex',
      to: 'Quarternion',
      convert: function (Complex){
        return new type.Quarternion(Complex);
      }
    }, {
      from: 'number',
      to: 'Quarternion',
      convert: function (number) {
        return new type.Quarternion(number,0,0,0);
      }
    }, {
      from: 'BigNumber',
      to: 'Quarternion',
      convert: function (bignumber) {
        return new type.Quarternion(bignumber.toNumber(),0,0,0);
      }
    }, {
      from: 'Fraction',
      to: 'Quarternion',
      convert: function (fraction) {
        return new type.Quarternion(fraction.toNumber(),0,0,0);
      }
    }, {
      from: 'null',
      to: 'Quarternion',
      convert: function(){
        return new type.Quarternion();
      }
    }
  ];
