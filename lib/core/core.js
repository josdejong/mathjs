...
exports.create = function create (options) {
  ...
  // TODO: move this function to typed-function
  math.typed.addType = function (type) {
    if (!type || typeof type.name !== 'string' || typeof type.test !== 'function') {
      throw new TypeError('Object with properties {name: string, test: function} expected');
    }

    // TODO: remove this conversion once redundant
    math.typed.types.push({
      type: type.name,
      test: type.test
    });
  };
  ...
  // TODO: move this function to typed-function
  math.typed.addConversion = function (conversion) {
    if (!conversion
    ...
    math.typed.conversions.push(conversion);
  };
