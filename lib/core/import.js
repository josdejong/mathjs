...
function factory (type, config, load, typed, math) {
  ...
  function _importFactory(factory, options) {
    if (typeof factory.name === 'string') {
      ...
      var existing = namespace[name];

      var lazyLoader = function () {

        console.log('load', name); // TODO: cleanup
        ...
        if (isTypedFunction(existing) && isTypedFunction(instance)) {
          ...
          // TODO: emit should take place after instance has been added.
      ...
      if (factory.lazy !== false) {
        lazy(namespace, name, lazyLoader);
      }
      else {
        namespace[name] = lazyLoader();
      }
    }
    else {
      // unnamed factory.
      ...
      console.log('load unnamed'); // TODO: cleanup
  ...
  // TODO: cleanup
  function _importFactory__(factory, options) {
    var instance = load(factory);
