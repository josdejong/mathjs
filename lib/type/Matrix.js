...
Matrix.prototype.get = function get(index) {
  ...
  if (index.length != this._size.length) {
    throw new util.error.DimensionError(index.length, this._size.length);
  }
...
function _get (matrix, index) {
  ...
  if (isScalar) {
    ...
    if (size.length != matrix._size.length) {
      throw new util.error.DimensionError(size.length, matrix._size.length);
    }
...
function _set (matrix, index, submatrix, defaultValue) {
  ...
  if (isScalar) {
    ...
    if (iSize.length < matrix._size.length) {
      throw new util.error.DimensionError(iSize.length, matrix._size.length, '<');
    }
    ...
    if (!object.deepEqual(iSize, sSize)) {
      throw new util.error.DimensionError(iSize, sSize);
    }
