...
/**
 * Get a string representation of the matrix, optionally rounding to a specified
 * number of digits.
 * @param {Number} [precision]   Number of digits to round the numbers
 * @returns {String} str
 */
Matrix.prototype.format = function format(precision) {
  return string.format(this._data, precision);
};
