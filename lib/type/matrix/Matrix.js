...
function factory (type, config, load, typed) {
  ...
  Matrix.prototype.distance: function (v) {
	var xy=this.getXY();
        var x = xy.x;
        var y = xy.y;
	var vxy = v.getXY();
  ...
  Matrix.prototype.rotate: function(rads) {
    ...
    this.set(0, ox * cos - oy * sin);
    this.set(1, y = ox * sin + oy * cos);

  },

  Matrix.prototype.divideByScalar: function(n) {
	var xy=this.getXY();
        var x = xy.x;
        var y = xy.y;
    x /= n;
  ...
  Matrix.prototype.multiplyByScalar: function(n) {
	var xy=this.getXY();
        var x = xy.x;
        var y = xy.y;
    x *= n;
