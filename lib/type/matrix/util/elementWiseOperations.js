...
function factory (type, config, load) {
  ...
  var algorithm4 = function (a, b, callback, inverse) {
    ...
    for (var j = 0; j < columns; j++) {
      ...
      _scatter(a, j, w, x, u, mark, c, cf, inverse);
      // scatter the values of B(:,j) into workspace
      _scatter(b, j, w, x, u, mark, c, cf, inverse);
   ...
   */
  var algorithm7 = function (s, b, callback, inverse) {
    // sparse matrix arrays
   ...
   * @param {boolean}  inverse           A true value indicates callback should be invoked f(Bij..z,Aij..z)
   *
   * @return {Matrix}                    DenseMatrix (C)
   *
   * https://github.com/josdejong/mathjs/pull/346#issuecomment-97658658
   */
  var algorithm10 = function (a, b, callback, inverse) {
    // a arrays
    var adata = a._data;
    var asize = a._size;
    var adt = a._datatype;
    ...
    var iterate = function (level, n, av, bv, cv) {
      ...
      if (level === asize.length - 1) {
        ...
        for (var i = 0; i < n; i++) {
          ...
          cv[i] = inverse ? cf(bv[i], av[i]) : cf(av[i], bv[i]);
        }
      }
      else {
   ...
   */
  var algorithm11 = function (a, b, callback, inverse) {
    // a arrays
    var adata = a._data;
    var asize = a._size;
