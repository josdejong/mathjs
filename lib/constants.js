...
function factory (type, config, load, typed, math) {
  ...
  if (config.number === 'bignumber') {
    ...
    object.lazy(math, 'pi',  function () {return bignumber.pi(type.BigNumber)});
    object.lazy(math, 'tau', function () {return bignumber.tau(type.BigNumber)});
    object.lazy(math, 'e',   function () {return bignumber.e(type.BigNumber)});
    object.lazy(math, 'phi', function () {return bignumber.phi(type.BigNumber)}); // golden ratio, (1+sqrt(5))/2
