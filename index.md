...
<table>
  <tr>
    <td>
      <a href="http://cdnjs.cloudflare.com/ajax/libs/mathjs/0.19.0/math.js">
        Development (version 0.19.0)
      </a>
    </td>
    <td>
      <span id="development-size">516 kB</span>, uncompressed with comments
    </td>
  </tr>
  <tr>
    <td>
      <a href="http://cdnjs.cloudflare.com/ajax/libs/mathjs/0.19.0/math.min.js">
        Production (version 0.19.0)
      </a>
    </td>
    <td>
      <span id="production-size">40 kB</span>, minified and gzipped
    </td>
  </tr>
</table>
